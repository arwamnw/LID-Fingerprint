 ...
 * Originally from (part of) nist_spblas.h
 *
...
*/
int NIST_SPBLAS::Table_insert(Sp_mat* S)
{
...
*/
int NIST_SPBLAS::Table_remove(unsigned int i)
{
...
void NIST_SPBLAS::Sp_mat::print() const
{
